...
module.exports = {
    run: (message, args, client) => {
        ...
        message.channel.send(new Discord.MessageEmbed()
            ...
            .addField('Date de naissance', moment(member.user.createdAt).format('[Le] DD/MM/YYYY [à] HH:mm:ss'), true)
            .addField('Date d\'entrée dans nos rangs', moment(member.joinedAt).format('[Le] DD/MM/YYYY [à] HH:mm:ss'), true)
